    ...
    return(
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div class="max-w-screen-md mb-8 lg:mb-16">
                <h2 class="mb-4 text-5xl tracking-tight font-bold text-[#67D7C1]  dark:text-white">Why Choose Us</h2>
                <p class=" font-semibold text-black  text-xl  dark:text-gray-400">Elevate Your Health Journey with Our Trusted Expertise</p>
            </div>
            <div class="space-y-8 mt-10 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                <div>
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Advanced Medical Expertise:</h3>
                    <p class="text-gray-500 dark:text-gray-400"> We boast state-of-the-art facilities equipped with the latest medical technology, providing you with access to the most advanced diagnostic and treatment options available.</p>
                </div>
                <div>
                    <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Cutting-Edge Facilities: </h3>
                ...
                <div>
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Comprehensive Services:</h3>
                    <p class="text-gray-500 dark:text-gray-400">From emergency care to specialized treatments, our hospital offers a wide range of services to meet all of your healthcare needs under one roof.</p>
                </div>
                <div>
                    <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Trusted Reputation</h3>
                    <p class="text-gray-500 dark:text-gray-400">With a long-standing reputation for delivering exceptional healthcare services to our community, you can trust us to provide compassionate, reliable care when you need it most.</p>
                </div>
                <div>
                    <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Patient-Centered Approach:n</h3>
                    <p class="text-gray-500 dark:text-gray-400">We prioritize your comfort, safety, and well-being, offering personalized care tailored to your unique medical requirements and preferences.</p>
                </div>
                <div>
                    <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <p class="text-gray-500 dark:text-gray-400"> Our hospital is dedicated to maintaining the highest standards of quality and safety in healthcare, earning accolades and accreditations that attest to our commitment to excellence.</p>
                </div>
            </div>
        </div>
      </section>
