import pic2 from "../../src/photo/pics 2.jpg";
import pic3 from "../../src/photo/pics 2.jpg";

export default function Team() {
  return (
    <>
      {/* <div className="  w-full flex  justify-center items-center   bg-[#F4FFFF] ">
        <div className="w-2/3 flex flex-col justify-center items-start">
          <h4 className="font-bold text-[#67D7C1]  ">Team</h4>
          <h1 className="font-bold text-5xl text-start my-4">Our Team</h1>
          <p className="w-2/3 text-start  font-semibold text-[#818180]  text-xl my-4">
            Empowering lives through knowledge, our Team at the health website
            is dedicated to delivering accurate one click at a time.
          </p>
          <div />
        </div>
      </div>
      <div className="w-full flex justify-center bg-[#F4FFFF] ">
        <div class="w-2/3 grid gap-x-8 gap-y-4 grid-cols-4">
          <div>
            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              ...
              <div class="p-5">
                ...
                <div className="grid-rows-3 flex justify-center ">
                  <svg
        ...
        <div class="container mx-auto px-6 md:px-12 xl:px-32">
          ...
          <div class="grid gap-12 items-center md:grid-cols-3">
            ...
            <div class="space-y-4 text-center">
              <img
                class="w-64 h-64 mx-auto object-cover rounded-xl md:w-40 md:h-40 lg:w-64 lg:h-64"
                src="https://img.freepik.com/free-photo/attractive-medical-professional-uniform-standing-with-arms-crossed-against-isolated-background_662251-416.jpg?size=626&ext=jpg&ga=GA1.1.1700460183.1708387200&semt=ais"
                alt="woman"
                loading="lazy"
                width="1000"
                height="667"
